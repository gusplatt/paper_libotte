...
g3 = teta(3) + teta(4) - 1; // no cálculo de ponto de bolha, as composições do vapor são incógnitas
g  = [g1 ; g2 ; g3];
...
estimap = 100;
estimay = 0.2;
//for N1 = 0.23:0.005:0.92// varredura de composições para fase líquida
for N1 = 0.92:0.0001:0.93// varredura de composições para fase líquida
