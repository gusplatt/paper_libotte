...
T   = 305.2; //% Temperatura em Kelvin (observe-se que T>Tc do etano, "double-dome")
...
N1 = 0.998966 ; // composição onde há vaporização retrógrada dupla
...
// cuidado: o gráfico é plotado com a mesma indiciação de uma matriz. Ou seja, a origem é no topo, à esquerda
// figura_certa_1: 0.01<x<0.99 ; 400<P<5100
// figura_certa_2: 0.90<x<0.99 ; 4500<P<5100
// figura_certa_3: 0.90<x<0.95 ; 4800<P<5100
// figura_certa_4: 0.95<x<0.99 ; 4800<P<5100
// figura_certa_5: 0.97<x<0.98 ; 4900<P<5000
...
teta0 = [estimax ; 1-estimax; N1 ; 1-N1; estimap];
N = [N1 ; 1-N1];
erro = 100;
cont = 0;
while (erro > 1e-8)
