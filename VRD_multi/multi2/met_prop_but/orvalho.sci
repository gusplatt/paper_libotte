...
N1 = [0.9991497 ; 0.0000116] ; // composição onde há vaporização retrógrada dupla (ponto linha = 100, coluna = 11)
...
teta0 = [estimax ; 1-1e-3-estimax ; 1e-3; N1 ; 1-N1(1)-N1(2) ; estimap]; // a composi��o (estimativa) do terceiro componente est� fixa
N = [N1 ; 1-N1(1)-N1(2)];
erro = 100;
cont = 0;
while (erro > 1e-8)
...
[nlin,ncol]=size(maty);
save('dados_orv.dat',matp,maty,matx)
